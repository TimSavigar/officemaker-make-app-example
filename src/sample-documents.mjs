...
export function buildAiLetter({
  ...
  purpose = 'follow up after a workflow trigger'
} = {}) {
  return {
    type: 'document',
    content: {
      children: [
        ...
        paragraph(`This letter was prepared by ${companyName} to ${purpose}.`),
        paragraph('The document was generated through the OfficeMaker public API.'),
...
export function buildBriefingDeck({
  title = 'OfficeMaker + Make',
  subtitle = 'Starter workflow example',
  highlights = ['Visual workflow builder', 'Straightforward HTTP module integration', 'Good fit for document pipelines']
} = {}) {
  return {
    type: 'powerpoint',
    slides: [
      ...
      },
      {
        ...
        shapes: [
          { type: 'textBox', shapeName: 'Title 1', text: 'Workflow fit' },
